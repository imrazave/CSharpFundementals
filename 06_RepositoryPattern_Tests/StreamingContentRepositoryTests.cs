...
namespace _06_RepositoryPattern_Tests
{
    ...
    public class StreamingContentRepositoryTests
    {
        ...
        public void UpdateExistingContent_ShouldReturnTrue()
        {
            // Arrange
            // TestInitialize
            StreamingContent newContent = new StreamingContent("Rubber", "A car tyre tcome to life with the power to make people explode and goes on a murderous rampage through the Californian desert.", "R", 10, false, GenreType.Romcom);
